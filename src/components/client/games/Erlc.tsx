...
import { ERLCTEXT } from "../../../../public/images/index.ts";
  ...
  return (
    <div className='bg-gray-900 text-white cursor-default'>
      <div className='isolate px-6 pt-14 lg:px-8'>
        ...
        <div className='mx-auto max-w-6xl px-10 sm:py-10 lg:py-2 lg:my-20 px-100 rounded-2xl bg-gradient-to-r from-[#4EABEE] to-[#DE151B]/20 shadow-2xl'>
          <div className='hidden sm:mb-8 sm:flex sm:justify-center'></div>
          <div className='text-center  py-10'>
            <h1 className='text-4xl font-bold tracking-tight text-white sm:text-6xl '>
              <Image src={ERLCTEXT} alt='ERLC' />
